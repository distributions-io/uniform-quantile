...
function validate( opts, options ) {
	...
	if ( options.hasOwnProperty( 'a' ) ) {
		opts.a = options.a;
		if ( !isNumber( opts.a ) ) {
			return new TypeError( 'quantile()::invalid option. `a` parameter must be a number primitive. Option: `' + opts.a + '`.' );
		}
	}
	if ( options.hasOwnProperty( 'b' ) ) {
		opts.b = options.b;
		if ( !isNumber( opts.b ) ) {
			return new TypeError( 'quantile()::invalid option. `b` parameter must be a number primitive. Option: `' + opts.b + '`.' );
		}
	}
